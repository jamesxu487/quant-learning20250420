...
# 导入自定义模块
from data_processing.data_processing import load_data_yf, load_data_av, flatten_columns, standardize_columns, load_data_month, load_data_year  # 版权所有: JayBee黄
...
def main():
    ...
    if provider == "yf":
        ...
        df = load_data_av(ticker, start_date, end_date, interval="5min", api_key="5JAXJUVPCSD3I266")

    # 判断是否成功下载数据
    if df.empty:
        print("未能下载数据。请检查股票代码或日期范围。")
        return
